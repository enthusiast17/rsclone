...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var postId, commentId, like, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 6, , 7]);
                postId = req.query.post ? req.query.post : null;
                commentId = req.query.comment ? req.query.comment : null;
                if (!postId && !commentId) {
                    throw new error_1.ErrorJSON(400, 'Bad Request', 'Please, correct http query.');
                }
                return [4 /*yield*/, Like_1.default.findOne().or([
                        { $and: [{ userId: req.userId }, { postId: postId }, { commentId: null }] },
                        { $and: [{ userId: req.userId }, { postId: null }, { commentId: commentId }] },
                    ])];
            case 1:
                like = _a.sent();
                if (!!like) return [3 /*break*/, 3];
                return [4 /*yield*/, new Like_1.default({
                        userId: req.userId,
                        postId: postId,
                        commentId: commentId,
                    }).save()];
            case 2:
                _a.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, like.deleteOne()];
            case 4:
                _a.sent();
                _a.label = 5;
