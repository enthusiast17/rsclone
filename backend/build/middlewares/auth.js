...
var authMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        try {
            verifiedUser = jsonwebtoken_1.default.verify(accessToken, process.env.ACCESS_TOKEN_SECRET_CODE);
            req.userId = verifiedUser.userId;
            next();
        }
        catch (error) {
            return [2 /*return*/, error_1.handleError(new error_1.ErrorJSON(401, 'Unauthorized.', 'Please, try to reload.'), req, res)];
        }
        return [2 /*return*/, res];
    });
}); };
